package com.springbook.biz.springJdbc.board.impl;
...
public class BoardDAOSpring {
	...
	// SQL ��ɾ��
	private final String BOARD_INSERT = "insert into board(seq, title, writer, content) values((select nvl(max(seq), 0) + 1 from board b),?,?,?)";
